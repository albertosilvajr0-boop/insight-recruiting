...
export const DEFAULT_CLIENT_NAME =
  import.meta.env.VITE_EMPLOYER_DISPLAY_NAME ||
  import.meta.env.VITE_CLIENT_DISPLAY_NAME ||
  PLATFORM_NAME
...
export const DEFAULT_CONTACT_EMAIL =
  import.meta.env.VITE_RECRUITING_CONTACT_EMAIL ||
  import.meta.env.VITE_RECRUITING_COMPLIANCE_EMAIL ||
  import.meta.env.VITE_RECRUITING_ACCOMMODATION_EMAIL ||
  'albertosilva@insightedgehq.com'
